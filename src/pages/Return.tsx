...
export default function Return() {
  ...
  // Filtra os itens para mostrar apenas os que estão em uso (podem ser devolvidos)
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  >
                    ...
                    <DialogContent>
                      <DialogHeader>
                        <DialogTitle>Adicionar Item para Devolução</DialogTitle>
                      </DialogHeader>
                      ...
                      <DialogFooter>
                        ...
                        <Button onClick={handleAddItemToReturn}>Adicionar</Button>
                      </DialogFooter>
                    </DialogContent>
                  </Dialog>
                </div>
