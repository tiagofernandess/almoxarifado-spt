...
import { FileText, Filter, Edit2, Trash2, Printer } from "lucide-react";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
...
import { generateInventoryPDF, generateMovementsReportPDF, generateMovementPDF } from "@/lib/pdf-generator";
...
export default function Reports() {
  ...
  const handlePrintMovement = (movement: ItemMovement) => {
    generateMovementPDF(movement, sellers);
  };
                            ...
                            <TableCell>
                              <div className="space-y-1">
                                ...
                                {movement.type === "checkout" && (
                                  <>
                                    {(movement.movimentoType === 'ponto_novo' || movement.pontoNovo) && (
                                      <div className="text-xs text-pink-600 mt-1">
                                        <div className="font-medium flex items-center gap-1">
                                          <span>📍</span>
                                          <span>Ponto Novo</span>
                                        </div>
                                        {movement.pontoNovoInfo && (
                                          <div className="text-gray-700 text-[11px] mt-1 px-2 py-1 bg-pink-50 rounded break-words">
                                            {movement.pontoNovoInfo}
                                          </div>
                                        )}
                                      </div>
                                    )}
                                    {movement.movimentoType === 'troca' && (
                                      <div className="text-xs text-blue-600 mt-1">
                                        ...
                                        {movement.trocaInfo && (
                                          <div className="text-gray-700 text-[11px] mt-1 px-2 py-1 bg-blue-50 rounded break-words">
                                            {movement.trocaInfo}
                                          </div>
                                        )}
                                      </div>
