...
export function useSupabase() {
  ...
  const getItems = useCallback(async (): Promise<Item[]> => {
    ...
    console.log('✅ Itens recebidos do Supabase:', data);
  ...
  const getMovements = useCallback(async (): Promise<ItemMovement[]> => {
    try {
      ...
      return data.map((movement: any) => ({
        ...
        movimentoType: movement.movimento_type || null,
        pontoNovoInfo: movement.ponto_novo_info || undefined,
        trocaInfo: movement.troca_info || undefined,
    ...
    try {
      ...
      const { data: movementData, error: movementError } = await supabase
        ...
        .insert([{
          ...
          movimento_type: movement.movimentoType || null,
          ponto_novo_info: movement.pontoNovoInfo || null,
          troca_info: movement.trocaInfo || null,
        }])
        .select()
        .single();
      ...
      return {
        ...
        movimentoType: movementData.movimento_type || null,
        pontoNovoInfo: movementData.ponto_novo_info || undefined,
        trocaInfo: movementData.troca_info || undefined,
    ...
    try {
      const { data, error } = await supabase
        ...
        .update({
          ...
          ...(movement.movimentoType !== undefined && { movimento_type: movement.movimentoType }),
          ...(movement.pontoNovoInfo !== undefined && { ponto_novo_info: movement.pontoNovoInfo }),
          ...(movement.trocaInfo !== undefined && { troca_info: movement.trocaInfo }),
        })
        .eq('id', id)
        .select()
        .single();
      ...
      return {
        ...
        date: data.date,
        pontoNovo: data.ponto_novo || false,
        movimentoType: data.movimento_type || null,
        pontoNovoInfo: data.ponto_novo_info || undefined,
        trocaInfo: data.troca_info || undefined,
        items: movement.items || [],
      };
    } catch (error: any) {
